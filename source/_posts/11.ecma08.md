...
#### 定义
    ...
    // 注：由于 IE11 的滚动条自动隐藏（尺寸为 0），所以它的窗口尺寸和视口尺寸是相等的
...
// 下面这个函数显示了 IE 和 Firefox 在读取页面元素的各种尺寸上的差异
``` javascript
// 读取页面及视口尺寸
...
function elemDimension(){
    ...
    if (window.innerWidth) {
        str += "<br> 窗口宽度 Window.innerWidth = "+iw;
        str += "<br> 窗口高度 Window.innerHeight = "+ih;
    }
    ...
    if (document.documentElement) {
        str += "<br><br> 视口宽度 document.documentElement.clientWidth = "+document.documentElement.clientWidth;
        str += "<br> 视口高度 document.documentElement.clientHeight = "+document.documentElement.clientHeight;
    ...
    if (document.body) {
        str += "<br><br> 视口宽度 document.body.clientWidth = "+document.body.clientWidth;
        str += "<br> 视口高度 document.body.clientHeight = "+document.body.clientHeight;
